 ...
 * - Index (Quick Connect): four steps; started by #onboarding-cta-see-options (welcome hub).
...
(function () {
  var TOUR_STEPS = [
    ...
    { selector: '#scan-vin-trigger', title: 'Capture VIN', copy: 'Use your camera to capture the vehicle\'s VIN. To pick brand, model, and engine yourself, use Select manually or Add details manually when those options appear in the connection flows.' },
  ...
  function init() {
    ...
    if (btn) {
      btn.addEventListener('click', function () {
        if (typeof window.onboardingHubMarkSeen === 'function') window.onboardingHubMarkSeen('options');
